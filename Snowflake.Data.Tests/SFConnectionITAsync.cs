...
class SFConnectionITAsync : SFBaseTestAsync
{
	...
	public void TestAsyncLoginTimeout()
	{
		if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
		{
			using (var conn = new MockSnowflakeDbConnection())
			{
				...
				{
					Assert.AreEqual(SnowflakeDbError.RequestTimeout, ((SnowflakeDbException)e.InnerException).SnowflakeError);
				}
				stopwatch.Stop();
	...
	public void TestAsyncConnectionFailFast()
	{
		using (var conn = new SnowflakeDbConnection())
		{
			...
			{
				Assert.AreEqual(SnowflakeDbError.InternalError, ((SnowflakeDbException)e.InnerException).SnowflakeError);
			}
