...
public sealed class SnowflakeException : DbException
{
	...
	public SnowflakeException(string sqlState, int vendorCode, string? errorMessage, string queryId) :
				base(errorMessage)
	{
		_sqlState = sqlState;
	...
	public SnowflakeException(SnowflakeError error, params object?[] args) :
		base(string.Format(CultureInfo.InvariantCulture, GetFormatString(error), args))
	{
		_errorCode = error;
	}

	public SnowflakeException(string sqlState, SnowflakeError error, params object[] args) :
		base(string.Format(CultureInfo.InvariantCulture, GetFormatString(error), args))
	{
		_errorCode = error;
		_sqlState = sqlState;
	...
	internal SnowflakeException(SnowflakeException innerException) : this(innerException.Message, innerException, innerException.SnowflakeError)
	{
	}

	public SnowflakeException(string message, Exception innerException, SnowflakeError error)
		: base(message, innerException)
	{
		_errorCode = error;
	}

	public SnowflakeException(Exception innerException, SnowflakeError error, params object[] args)
		: base(string.Format(CultureInfo.InvariantCulture, GetFormatString(error), args), innerException)
	{
		_errorCode = error;
	}

	public SnowflakeException(Exception innerException, string sqlState, SnowflakeError error, params object[] args)
		: base(string.Format(CultureInfo.InvariantCulture, GetFormatString(error), args), innerException)
	{
		_errorCode = error;
		_sqlState = sqlState;
