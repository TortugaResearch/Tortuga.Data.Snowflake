...
public class SnowlfakeDbDataAdapter : DbDataAdapter
{
	public SnowlfakeDbDataAdapter()
	{
	}

	public SnowlfakeDbDataAdapter(SnowflakeDbCommand selectCommand) : this()
	{
		SelectCommand = selectCommand;
	}

	public SnowlfakeDbDataAdapter(string selectCommandText, SnowflakeDbConnection selectConnection) : this()
	{
