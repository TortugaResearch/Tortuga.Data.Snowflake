...
public record SnowflakeDbConfiguration
{
	public SnowflakeDbConfiguration(bool useV2JsonParser, bool useV2ChunkDownloader, int chunkDownloaderVersion)
	{
	...
	public static SnowflakeDbConfiguration Default { get; set; } =
